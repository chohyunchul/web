...
from Project.clu_util import cluster_util
...
def load_indians():
    ...
    model_indians = load_model(os.path.join(app.root_path, 'model/pima.h5'))
...
#         test_data1 = np.array([pregnant, plasma, pressure, thickness, insulin, BMI, pedigree, age]).reshape(1, 8)
#         results = sp_names[model_indians.predict_classes(test_data1)[0][0]]

#         indians = {'pregnant': pregnant, 'plasma': plasma, 'pressure': pressure, 'thickness': thickness,
#                 'insulin': insulin, 'bmi': BMI, 'pedigree': pedigree, 'age':age, 'results': results}
